...
HandleErrors:
    ...
    Public Function RTZUpdate(
        ...
        Dim endpoint As New IPEndPoint(IPAddress.Parse("9.9.9.9"), 53) 'hard code to get around fedramp
        Dim client As New LookupClient(endpoint)
        Dim txt As String
        ...
        Select Case Err.Number
            ...
            Case Else
                Msg = "Error # " & Str(Err.Number) & " was generated by " _
                    & Err.Source & Chr(13) & "Error Line: " & Erl() & Chr(13) & Err.Description
                MsgBox(Msg, MsgBoxStyle.Critical, "Error")
                RTZUpdate = CType(ExcelError.ExcelErrorValue, Object)
        End Select
