...
Public Module MyFunctions
    ...
    Public Function AValue(
        ...
        A1A2 = Left(UCase(A1A2.ToString), 1)
...
HandleErrors:
    ...
    Public Function DCF(
        ...
        SIConv = If(SI = 0, 1, rem2Sv * 1000000.0 / Ci2Bq)
        ...
        'Sanitize Input
        Isotope = UCase(Isotope)
        DCFStd = Left(UCase(DCFStd.ToString), 2)
        DCFPath = Left(UCase(DCFPath), 3)
        DCFType = Left(UCase(DCFType), 1)
        DCFAMAD = Left(UCase(DCFAMAD.ToString), 1)
...
HandleErrors:
        If Err.Number <> 0 Then
            Dim msgBoxResult As Object = MsgBox("Error # " & Str(Err.Number) & " was generated by " _
...
HandleErrors:
    ...
    <ExcelFunction(Description:="List available RadToolz functions", Category:="RadToolz", IsMacroType:=True)>
...
HandleErrors:
    ...
    <ExcelFunction(Description:="List all isotopes And values for all isotopes", Category:="RadToolz", IsMacroType:=True)>
...
HandleErrors:
    ...
    Public Function RTZRefs(
        ...
        ENSDF = "Nuclide data and adapted equations are from:" & vbCrLf &
                vbCrLf &
                "    Evaluated Nuclear Structure Data File (ENSDF), Brookhaven" & vbCrLf &
                "    National Laboratory. Upton, NY 11973-5000." & vbCrLf &
                "    https://www.nndc.bnl.gov/ as of 7/7/2026" & vbCrLf & vbCrLf
...
HandleErrors:
        If Err.Number <> 0 Then
            Msg = "Error # " & Str(Err.Number) & " was generated by " _
             & Err.Source & Chr(13) & "Error Line: " & Erl() & Chr(13) & Err.Description
            msgBoxResult = MsgBox(Msg, MsgBoxStyle.Critical, "Error")
        End If
